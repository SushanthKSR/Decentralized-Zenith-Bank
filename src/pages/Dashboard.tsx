  ...
  const quickActions = [
    {
      ...
      link: "/transfer",
      color: "https://zenith-defibank.vercel.app/transfer",
    },
    {
      title: "Receive",
      ...
      >
          ...
          <div className="flex flex-wrap md:flex-nowrap items-center justify-between">
            ...
            <div className="w-full md:w-auto grid grid-cols-2 md:grid-cols-3 gap-4">
              ...
              <div className="bg-dark-800 rounded-lg p-3">
                ...
                <p className="text-lg font-semibold">
                  ${(parseFloat(balance) * 3500).toFixed(2)}
                </p>
              </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          {quickActions.map((action, index) => (
            ...
            >
              <div
                className={`h-12 w-12 rounded-full bg-gradient-to-r ${action.color} flex items-center justify-center mb-3`}
              >
                {action.icon}
              </div>
